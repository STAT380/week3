...
![Image credit: R for Data Science (https://r4ds.had.co.nz/model-intro.html)](https://d33wubrfki0l68.cloudfront.net/e5bf2a8f4c787a12facbc0b4191fc82bd192f4c5/4e5d2/diagrams/data-science-model.png)
...
tally(~ arr_delay < tolerance28, data = OrdDelays, format = "proportion")
```
...
# summary comparison
favstats( X97. ~ SampleSize, data = BothSims)
...
qdata(~  X97., p = 0.8, data = BootStrapTrials)
